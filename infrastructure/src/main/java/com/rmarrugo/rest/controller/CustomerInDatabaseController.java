...
@RestController
public class CustomerInDatabaseController {
    ...
    public CustomerInDatabaseController(@Qualifier("inDatabaseFinderUseCase") CustomerFinder finder,
                                        @Qualifier("inDatabaseSaverUseCase") CustomerSaver saver,
                                        @Qualifier("inDatabaseDeleterUseCase") CustomerDeleter deleter,
